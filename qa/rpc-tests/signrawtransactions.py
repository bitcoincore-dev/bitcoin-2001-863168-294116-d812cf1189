...
class SignRawTransactionsTest(BitcoinTestFramework):
    ...
    def script_verification_error_test(self):
        ...
        assert 'txinwitness' in rawTxSigned['errors'][0]
        ...
        assert not rawTxSigned['errors'][0]['txinwitness']
        ...
        assert_equal(rawTxSigned['errors'][1]['txinwitness'], ["304402203609e17b84f6a7d30c80bfa610b5b4542f32a8a0d5447a12fb1366d7f01cc44a0220573a954c4518331561406f90300e8f3358f51928d43c212a8caed02de67eebee01", "025476c2e83188368da1ff3e292e7acafcdb3566bb0ad253f62fc70f07aeee6357"])
        assert not rawTxSigned['errors'][0]['txinwitness']
