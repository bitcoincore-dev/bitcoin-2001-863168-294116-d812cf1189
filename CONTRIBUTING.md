...
The project coding conventions in the [developer notes](doc/devel/dev-notes.md)
must be followed.
...
[Translation Process](/doc/devel/translation_process.md)
...
notes](/doc/devel/productivity.md#diff-the-diffs-with-git-range-diff). To avoid needless review churn, maintainers will
...
In general, all pull requests must:
  ...
  - Follow code style guidelines ([C++](doc/devel/dev-notes.md), [functional tests](test/functional/README.md));
...
about:
  ...
  - It may be because the changes you are suggesting do not appeal to people. Rather than
    ...
    [developer notes](doc/devel/dev-notes.md), is dangerous or insecure, is messily written, etc.
