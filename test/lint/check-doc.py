...
def main():
    ...
    # missing hidden wallet args
    if sys.version_info >= (3, 6):
        wallet_args = check_output(CMD_GREP_WALLET_ARGS, shell=True, universal_newlines=True, encoding='utf8')
        wallet_hidden_args = check_output(CMD_GREP_WALLET_HIDDEN_ARGS, shell=True, universal_newlines=True, encoding='utf8')
    else:
