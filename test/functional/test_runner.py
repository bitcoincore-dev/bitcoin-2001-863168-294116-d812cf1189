...
def main():
    ...
    parser.add_argument("--configfile", dest="configfile", default=os.path.abspath(os.path.dirname(__file__) + "/../config.ini"), help="Location of the test framework config file (default: %(default)s)")
