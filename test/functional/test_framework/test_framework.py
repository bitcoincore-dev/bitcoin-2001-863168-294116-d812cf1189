...
class BitcoinTestFramework(object):
    ...
    def start_node(self, i, dirname, extra_args=None, rpchost=None, timewait=None, binary=None, stderr=None):
        ...
        args = [binary, "-datadir=" + datadir, "-server", "-keypool=1", "-keypoolmin=0", "-discover=0", "-rest", "-logtimemicros", "-debug", "-debugexclude=libevent", "-debugexclude=leveldb", "-mocktime=" + str(self.mocktime), "-uacomment=testnode%d" % i]
    ...
    def _initialize_chain(self, test_dir, num_nodes, cachedir):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                args = [os.getenv("BITCOIND", "bitcoind"), "-server", "-keypool=1", "-keypoolmin=0", "-datadir=" + datadir, "-discover=0"]
                if i > 0:
