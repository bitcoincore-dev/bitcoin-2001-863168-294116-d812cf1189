...
class MempoolAcceptV3(BitcoinTestFramework):
    ...
    def test_v3_max_vsize(self):
        ...
        expected_error_heavy = f"truc-vsize-toobig, v3 tx {tx_v3_heavy['txid']} (wtxid={tx_v3_heavy['wtxid']}) is too big"
    ...
    def test_v3_acceptance(self):
        ...
        expected_error_child_heavy = f"truc-child-toobig, v3 child tx {tx_v3_child_heavy['txid']} (wtxid={tx_v3_child_heavy['wtxid']}) is too big"
    ...
    def test_v3_replacement(self):
        ...
        expected_error_v2_v3 = f"truc-spent-by-nontruc, non-v3 tx {tx_v3_child_rbf_v2['txid']} (wtxid={tx_v3_child_rbf_v2['wtxid']}) cannot spend from v3 tx {tx_v3_parent['txid']} (wtxid={tx_v3_parent['wtxid']})"
    ...
    def test_v3_ancestors_package(self):
        ...
        assert_equal(result['package_msg'], f"truc-child-toobig, v3 child tx {tx_v3_child_heavy['txid']} (wtxid={tx_v3_child_heavy['wtxid']}) is too big: {tx_v3_child_heavy['tx'].get_vsize()} > 1000 virtual bytes")
        self.check_mempool([])
    ...
    def test_v3_package_inheritance(self):
        ...
        assert_equal(result['package_msg'], f"truc-spent-by-nontruc, non-v3 tx {tx_v2_child['txid']} (wtxid={tx_v2_child['wtxid']}) cannot spend from v3 tx {tx_v3_parent['txid']} (wtxid={tx_v3_parent['wtxid']})")
        self.check_mempool([])
    ...
    def test_v3_in_testmempoolaccept(self):
        ...
        expected_error_v3_from_v2 = f"truc-spends-nontruc, v3 tx {tx_v3_from_v2['txid']} (wtxid={tx_v3_from_v2['wtxid']}) cannot spend from non-v3 tx {tx_v2['txid']} (wtxid={tx_v2['wtxid']})"
        ...
        expected_error_v2_from_v3 = f"truc-spent-by-nontruc, non-v3 tx {tx_v2_from_v3['txid']} (wtxid={tx_v2_from_v3['wtxid']}) cannot spend from v3 tx {tx_v3['txid']} (wtxid={tx_v3['wtxid']})"
