...
def test_setfeerate(self, rbf_node, dest_address):
    ...
    test_response(requested=new, error=True, msg="The requested fee rate of %s sat/vB cannot be greater than the wallet max fee rate of 10000.000 sat/vB. The current setting of 0 (unset) for this wallet remains unchanged." % (new,))
    new = Decimal("0.999")
    test_response(requested=new, error=True, msg="The requested fee rate of %s sat/vB cannot be less than the minimum relay fee rate of 1.000 sat/vB. The current setting of 0 (unset) for this wallet remains unchanged." % (new,))
    fee_rate = Decimal("2.001")
    test_response(requested=fee_rate, expected=fee_rate, msg="Fee rate for transactions with this wallet successfully set to %s sat/vB" % (fee_rate,))
    new = Decimal("1.999")
    test_response(requested=new, expected=fee_rate, error=True, msg="The requested fee rate of %s sat/vB cannot be less than the wallet min fee rate of 2.000 sat/vB. The current setting of %s sat/vB for this wallet remains unchanged." % (new, fee_rate))
    ...
    new = "2.501"
    test_response(requested=new, error=True, msg="The requested fee rate of %s sat/vB cannot be greater than the wallet max fee rate of 2.500 sat/vB. The current setting of 0 (unset) for this wallet remains unchanged." % (new,))
