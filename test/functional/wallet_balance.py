...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.generatetoaddress(self.nodes[0], 2, self.nodes[0].get_deterministic_priv_key().address)
        ...
        self.generatetoaddress(self.nodes[0], 6, self.nodes[0].get_deterministic_priv_key().address)
