...
#### For macOS cross compilation
    ...
    sudo apt-get install curl librsvg2-bin libtiff-tools bsdmainutils cmake imagemagick libcap-dev zlib1g-dev libbz2-dev python3-setuptools libtinfo5
...
Common linux dependencies:
    ...
    sudo apt-get install make automake cmake curl g++-multilib libtool binutils-gold bsdmainutils pkg-config python3 patch zlib1g-dev
