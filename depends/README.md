...
you must set `CONFIG_SITE` environment variable to appropriate
`depends/<host-platform-triplet>/share/config.site` settings file. In the above
example, a file named `depends/x86_64-w64-mingw32/share/config.site` will be
