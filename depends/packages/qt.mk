...
$(package)_patches+= fix_bigsur_drawing.patch force_bootstrap.patch set_native_build_versions.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/set_native_build_versions.patch && \
