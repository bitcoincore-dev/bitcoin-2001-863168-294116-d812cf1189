...
$(1)_config_env+=PATH=$(build_prefix)/bin:$($($(1)_type)_prefix)/bin:$(PATH)
$(1)_build_env+=PATH=$(build_prefix)/bin:$($($(1)_type)_prefix)/bin:$(PATH)
$(1)_stage_env+=PATH=$(build_prefix)/bin:$($($(1)_type)_prefix)/bin:$(PATH)
