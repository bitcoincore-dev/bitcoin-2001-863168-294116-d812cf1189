...
-DCMAKE_C_COMPILER='clang-18;-ftrivial-auto-var-init=pattern' \
-DCMAKE_CXX_COMPILER='clang++-18;-ftrivial-auto-var-init=pattern' \
-DCMAKE_CXX_FLAGS='-DARENA_DEBUG -DDEBUG_LOCKORDER'"
