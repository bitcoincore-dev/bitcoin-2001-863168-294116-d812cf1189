...
export BITCOIN_CONFIG="-DWITH_ZMQ=ON -DWARN_INCOMPATIBLE_BDB=OFF -DWITH_GUI=OFF -DCMAKE_C_COMPILER='clang;-gdwarf-4' -DCMAKE_CXX_COMPILER='clang++;-gdwarf-4'"  # TODO enable GUI
