...
export GOAL="install"
export BITCOIN_CONFIG="-DCMAKE_C_COMPILER=clang-${TIDY_LLVM_V} -DCMAKE_CXX_COMPILER=clang++-${TIDY_LLVM_V} -DWARN_INCOMPATIBLE_BDB=OFF -DHARDENING=OFF -DAPPEND_CFLAGS='-O0 -g0' -DAPPEND_CXXFLAGS='-O0 -g0'"
