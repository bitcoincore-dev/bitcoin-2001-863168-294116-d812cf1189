...
function(print_config_flags)
  macro(print_flags config)
    string(TOUPPER "${config}" config_uppercase)
    message(" - Preprocessor defined macros ........ ${definitions_ALL} ${definitions_${config_uppercase}}")
    message(" - CFLAGS ............................. ${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_${config_uppercase}}")
    message(" - CXXFLAGS ........................... ${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_${config_uppercase}}")
    message(" - LDFLAGS for executables ............ ${CMAKE_EXE_LINKER_FLAGS} ${CMAKE_EXE_LINKER_FLAGS_${config_uppercase}}")
  endmacro()
