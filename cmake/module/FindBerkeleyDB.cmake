...
if(BREW_COMMAND)
  ...
  set(_BerkeleyDB_homebrew_include_hint)
  foreach(_suffix IN ITEMS db@4 db@5)
    execute_process(
    ...
    list(APPEND _BerkeleyDB_homebrew_include_hint "${_BerkeleyDB_homebrew_prefix}/include")
  endforeach()
...
find_path(BerkeleyDB_INCLUDE_DIR
  NAMES db_cxx.h
  HINTS ${_BerkeleyDB_homebrew_include_hint}
  PATH_SUFFIXES 4.8 48 4 db4 5.3 5 db5
)
mark_as_advanced(BerkeleyDB_INCLUDE_DIR)
unset(_BerkeleyDB_homebrew_include_hint)
