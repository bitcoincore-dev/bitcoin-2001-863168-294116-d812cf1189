...
if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
  execute_process(COMMAND brew --prefix berkeley-db@4 OUTPUT_VARIABLE bdb4_brew_prefix ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()

find_path(BerkeleyDB_INCLUDE_DIR
  NAMES db.h
  HINTS ${bdb4_brew_prefix}/include
  PATH_SUFFIXES 4.8 48 4 db4 5 5.3
)
...
find_library(BerkeleyDB_LIBRARY
  NAMES db_cxx-4.8 libdb48 db4_cxx db_cxx
