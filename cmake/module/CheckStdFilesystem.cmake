...
function(check_std_filesystem)
  ...
  check_cxx_source_links("${source}" STD_FILESYSTEM_NO_LINK_NEEDED)
  if(STD_FILESYSTEM_NO_LINK_NEEDED)
    return()
  endif()

  add_library(std_filesystem INTERFACE)
  set(CMAKE_REQUIRED_LIBRARIES stdc++fs)
  check_cxx_source_links("${source}" STD_FILESYSTEM_NEEDS_LINK_TO_STDCXXFS)
  if(STD_FILESYSTEM_NEEDS_LINK_TO_STDCXXFS)
    target_link_libraries(std_filesystem INTERFACE ${CMAKE_REQUIRED_LIBRARIES})
    return()
  endif()
  set(CMAKE_REQUIRED_LIBRARIES c++fs)
  check_cxx_source_links("${source}" STD_FILESYSTEM_NEEDS_LINK_TO_CXXFS)
