...
target_compile_definitions(crc32c PRIVATE BYTE_ORDER_BIG_ENDIAN=${WORDS_BIGENDIAN})
...
if(HAVE_SSE42)
  ...
  add_library(crc32c_sse42 OBJECT EXCLUDE_FROM_ALL ${CMAKE_SOURCE_DIR}/src/crc32c/src/crc32c_sse42.cc)
...
if(HAVE_ARM64_CRC32C)
  ...
  add_library(crc32c_arm64 OBJECT EXCLUDE_FROM_ALL ${CMAKE_SOURCE_DIR}/src/crc32c/src/crc32c_arm64.cc)
