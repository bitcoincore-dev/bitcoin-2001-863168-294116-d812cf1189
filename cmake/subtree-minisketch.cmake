...
target_sources(minisketch
  PRIVATE
    ...
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_1byte.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_2bytes.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_3bytes.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_4bytes.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_5bytes.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_6bytes.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_7bytes.cpp>
    $<$<BOOL:${HAVE_CLMUL}>:${CMAKE_SOURCE_DIR}/src/minisketch/src/fields/clmul_8bytes.cpp>
)
...
target_compile_options(minisketch
  PRIVATE
    ...
    $<$<CXX_COMPILER_ID:MSVC>:/wd4065 /wd4146>
)
