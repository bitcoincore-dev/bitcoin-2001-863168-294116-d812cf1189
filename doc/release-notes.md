Bitcoin Knots version *0.17.1.knots20181229* is now available from:

  <https://bitcoinknots.org/files/0.17.x/0.17.1.knots20181229/>
...
- n/a    `fb4241d` *Qt/Options: Replace prune setting with rwconf-based version (luke-jr)
- #8550  `eac2e47` *GUI/MempoolStats: Use double type in pow (luke-jr)
...
- #14066 `51f311a` *gitian-linux: Build binaries for 64-bit POWER (luke-jr)
