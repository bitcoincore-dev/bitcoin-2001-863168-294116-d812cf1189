...
To enable testing branch coverage:
```
cmake -DLCOV_RC="lcov_branch_coverage=1" -P build/Coverage.cmake  # For LCOV v1.
cmake -DLCOV_RC="branch_coverage=1" -P build/Coverage.cmake       # For LCOV v2.
```
