...
UniValue prioritisetransaction(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "2. priority_delta (numeric, optional) Must be zero.\n"
            "                  Other node software uses this field for prioritisation, but " PACKAGE_NAME " does not support it.\n"
    ...
    if (request.params[1].get_real() != 0) {
        throw JSONRPCError(RPC_INVALID_PARAMS, "Priority not supported");
    }
