...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        ...
        "\nReturn information about the given bitcoin address.\n",
        {
            ...
            {"address_type", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "DEPRECATED", "", {}, /* hidden */ true},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
...
static RPCHelpMan createmultisig()
{
    return RPCHelpMan{"createmultisig",
                ...
                "Public keys can be sorted according to BIP67 during the request if required.\n",
                {
                    ...
                    {"options|address_type", {RPCArg::Type::OBJ, RPCArg::Type::STR}, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                        {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    CTxDestination dest;
    {
        ...
        if (!reservedest->GetReservedDestination(dest, false, dest_err)) {
