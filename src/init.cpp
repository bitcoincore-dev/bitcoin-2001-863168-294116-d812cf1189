...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    LogPrintf("* Using %.1fMiB for UTXO set (plus up to %.1fMiB of unused mempool space)\n", (nCoinCachePlusMempoolUsage - nMempoolSizeMax) * (1.0 / 1024 / 1024), nMempoolSizeMax * (1.0 / 1024 / 1024));
