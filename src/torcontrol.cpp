...
{
public:
    TorController(struct event_base* base, const std::string& control_socket);
    ~TorController();
...
TorController::TorController(struct event_base* _base, const std::string& control_socket):
    base(_base),
