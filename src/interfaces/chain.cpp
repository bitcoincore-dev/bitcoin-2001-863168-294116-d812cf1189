...
{
public:
    explicit NotificationsHandlerImpl(Chain::Notifications& notifications) : m_notifications(&notifications)
    {
...
public:
    ...
    {
        return MakeUnique<NotificationsHandlerImpl>(notifications);
    }
...
std::unique_ptr<Handler> ChainImpl::handleRpc(const CRPCCommand& command)
{
    ...
    // When inserted.second is false, registerForwarder was already called and
