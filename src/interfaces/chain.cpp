...
public:
    ...
    CFeeRate getMinFeeRate(const CCoinControl& coin_control, FeeCalculation* calc) override
    {
        CHECK_WALLET(return GetMinimumFeeRate(coin_control, ::mempool, ::feeEstimator, calc));
    }
