#ifndef BITCOIN_INTERFACES_CAPNP_PROXY_INL_H
#define BITCOIN_INTERFACES_CAPNP_PROXY_INL_H
...
void BuildField(TypeList<LocalTypes...>, Context& context, Output&& output, Values&&... values)
{
    if (CustomHasValue(context, std::forward<Values>(values)...)) {
        CustomBuildField(TypeList<LocalTypes...>(), BuildFieldPriority(), context, std::forward<Values>(values)...,
...
#endif // BITCOIN_INTERFACES_CAPNP_PROXY_INL_H
