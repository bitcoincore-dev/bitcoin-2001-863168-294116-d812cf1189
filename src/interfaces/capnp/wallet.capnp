...
interface Wallet $Proxy.wrap("interfaces::Wallet") {
    ...
    getKeyFromPool @10 (context :Proxy.Context, internal :Bool) -> (pubKey :Data, result :Bool);
    ...
    createTransaction @27 (context :Proxy.Context, recipients :List(Recipient), coinControl :CoinControl, sign :Bool, changePos :Int32) -> (changePos :Int32, fee :Int64, failReason :Text, result :PendingWalletTx);
    ...
    tryGetBalances @40 (context :Proxy.Context) -> (balances :WalletBalances, numBlocks :Int32, result :Bool);
    ...
    txinIsMine @43 (context :Proxy.Context, txin :Data) -> (result :Int32);
    txoutIsMine @44 (context :Proxy.Context, txout :Data) -> (result :Int32);
    getDebit @45 (context :Proxy.Context, txin :Data, filter :Int32) -> (result :Int64);
    getCredit @46 (context :Proxy.Context, txout :Data, filter :Int32) -> (result :Int64);
    ...
    getDefaultAddressType @55 (context :Proxy.Context) -> (result :Int32);
    getDefaultChangeType @56 (context :Proxy.Context) -> (result :Int32);
    getDefaultMaxTxFee @57 (context :Proxy.Context) -> (result :Int64);
    remove @58 (context :Proxy.Context) -> ();
    handleUnload @59 (context :Proxy.Context, callback :UnloadWalletCallback) -> (result :Handler.Handler);
    handleShowProgress @60 (context :Proxy.Context, callback :ShowWalletProgressCallback) -> (result :Handler.Handler);
    handleStatusChanged @61 (context :Proxy.Context, callback :StatusChangedCallback) -> (result :Handler.Handler);
    handleAddressBookChanged @62 (context :Proxy.Context, callback :AddressBookChangedCallback) -> (result :Handler.Handler);
    handleTransactionChanged @63 (context :Proxy.Context, callback :TransactionChangedCallback) -> (result :Handler.Handler);
    handleWatchOnlyChanged @64 (context :Proxy.Context, callback :WatchOnlyChangedCallback) -> (result :Handler.Handler);
    handleCanGetAddressesChanged @65 (context :Proxy.Context, callback :CanGetAddressesChangedCallback) -> (result :Handler.Handler);
}

interface PendingWalletTx $Proxy.wrap("interfaces::PendingWalletTx") {
    destroy @0 (context :Proxy.Context) -> ();
    customGet @1 (context :Proxy.Context) -> (result :Data) $Proxy.name("get");
    commit @2 (context :Proxy.Context, valueMap :List(Common.Pair(Text, Text)), orderForm :List(Common.Pair(Text, Text))) -> (rejectReason :Text, result :Bool);
}
...
struct WalletAddress $Proxy.wrap("WalletAddress") {
...
struct WalletTx $Proxy.wrap("WalletTx") {
    tx @0 :Data;
...
struct WalletTxOut $Proxy.wrap("WalletTxOut") {
    txout @0 :Data;
    time @1 :Int64;
...
struct WalletTxStatus $Proxy.wrap("WalletTxStatus") {
...
struct WalletBalances $Proxy.wrap("WalletBalances") {
    balance @0 :Int64;
