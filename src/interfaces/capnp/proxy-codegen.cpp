...
#define PROXY_INL "interfaces/capnp/proxy-inl.h"
...
void Generate(kj::StringPtr input_schema, kj::StringPtr import_path, kj::StringPtr output_stem)
{
    ...
    cpp_server << "#include <" << stem << ".capnp.proxy-inl.h>\n";
    cpp_server << "#include <" << PROXY_INL << ">\n\n";
    cpp_server << "namespace interfaces {\n";
    cpp_server << "namespace capnp {\n";

    std::ofstream cpp_client(stem + ".capnp.proxy-client.c++");
    cpp_client << "// Generated by " PROXY_BIN " from " << input_schema << "\n\n";
    cpp_client << "#include <" << stem << ".capnp.proxy-inl.h>\n";
    cpp_client << "#include <" << PROXY_INL << ">\n\n";
    cpp_client << "namespace interfaces {\n";
    cpp_client << "namespace capnp {\n";

    std::ofstream cpp_types(stem + ".capnp.proxy-types.c++");
    cpp_types << "// Generated by " PROXY_BIN " from " << input_schema << "\n\n";
    cpp_types << "#include <" << stem << ".capnp.proxy-inl.h>\n";
    cpp_types << "#include <" << PROXY_INL << ">\n\n";
    cpp_types << "namespace interfaces {\n";
    cpp_types << "namespace capnp {\n";
    ...
    std::ofstream inl(stem + ".capnp.proxy-inl.h");
    inl << "// Generated by " PROXY_BIN " from " << input_schema << "\n\n";
    inl << "#ifndef " << guard << "_CAPNP_PROXY_INL_H\n";
    inl << "#define " << guard << "_CAPNP_PROXY_INL_H\n\n";
    inl << "#include <" << stem << ".capnp.proxy.h>\n";
    inl << "#include <" << stem << "-inl.h>\n\n";
    inl << "namespace interfaces {\n";
    inl << "namespace capnp {\n";
