...
interface Node $X.proxy("interfaces::Node") {
    ...
    handleInitMessage @52 (context :X.Context, callback :InitMessageCallback) -> (result :Handler);
    handleMessageBox @53 (context :X.Context, callback :MessageBoxCallback) -> (result :Handler);
    handleQuestion @54 (context :X.Context, callback :QuestionCallback) -> (result :Handler);
    handleShowProgress @55 (context :X.Context, callback :ShowNodeProgressCallback) -> (result :Handler);
    handleLoadWallet @56 (context :X.Context, callback :LoadWalletCallback) -> (result :Handler);
    handleNotifyNumConnectionsChanged @57 (context :X.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler);
    handleNotifyNetworkActiveChanged @58 (context :X.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler);
    handleNotifyAlertChanged @59 (context :X.Context, callback :NotifyAlertChangedCallback) -> (result :Handler);
    handleBannedListChanged @60 (context :X.Context, callback :BannedListChangedCallback) -> (result :Handler);
    handleNotifyBlockTip @61 (context :X.Context, callback :NotifyBlockTipCallback) -> (result :Handler);
    handleNotifyHeaderTip @62 (context :X.Context, callback :NotifyHeaderTipCallback) -> (result :Handler);
}
