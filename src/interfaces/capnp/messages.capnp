...
interface Init extends(X.Init) $X.proxy("interfaces::Init") {
    makeNode @0 (context :X.Context) -> (result :Node);
    makeWalletClient @1 (context :X.Context, chain :Chain, walletFilenames :List(Text), globalArgs :GlobalArgs $X.count(0)) -> (result :ChainClient);
}
...
interface ChainClient $X.proxy("interfaces::ChainClient") {
    ...
    prepare @1 (context :X.Context) -> (result :Bool);
    start @2 (context :X.Context, scheduler :Void) -> ();
    stop @3 (context :X.Context) -> ();
    shutdown @4 (context :X.Context) -> ();
    setMockTime @5 (context :X.Context, time :Int64) -> ();
    getWallets @6 (context :X.Context) -> (result :List(Wallet));
    destroy @7 (context :X.Context) -> ();
}
...
interface Wallet $X.proxy("interfaces::Wallet") {
    ...
    getDefaultAddressType @52 (context :X.Context) -> (result :Int32);
    getDefaultChangeType @53 (context :X.Context) -> (result :Int32);
    handleUnload @54 (context :X.Context, callback :UnloadWalletCallback) -> (result :Handler);
    handleShowProgress @55 (context :X.Context, callback :ShowWalletProgressCallback) -> (result :Handler);
    handleStatusChanged @56 (context :X.Context, callback :StatusChangedCallback) -> (result :Handler);
    handleAddressBookChanged @57 (context :X.Context, callback :AddressBookChangedCallback) -> (result :Handler);
    handleTransactionChanged @58 (context :X.Context, callback :TransactionChangedCallback) -> (result :Handler);
    handleWatchOnlyChanged @59 (context :X.Context, callback :WatchOnlyChangedCallback) -> (result :Handler);
    destroy @60 (context :X.Context) -> ();
}
