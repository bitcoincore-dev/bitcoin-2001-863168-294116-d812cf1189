...
interface Chain $X.proxy("interfaces::Chain") {
    ...
    maxTxFee @14 (context :X.Context) -> (result :Int64);
    ...
    handleNotifications @23 (context :X.Context, notifications :ChainNotifications) -> (result :Handler);
    waitForNotifications @24 (context :X.Context) -> ();
    handleRpc @25 (context :X.Context, command :RPCCommand) -> (result :Handler);
}
