...
interface Chain $X.proxy("interfaces::Chain") {
    ...
    findCoins @4 (context :X.Context, coins :List(Pair(Data, Data))) -> (coins :List(Pair(Data, Data)));
    ...
    relayTransaction @8 (context :X.Context, txid :Data) -> ();
    ...
    estimateMaxBlocks @12 (context :X.Context) -> (result :UInt32);
    mempoolMinFee @13 (context :X.Context) -> (result :Data);
    relayMinFee @14 (context :X.Context) -> (result :Data);
    relayIncrementalFee @15 (context :X.Context) -> (result :Data);
    relayDustFee @16 (context :X.Context) -> (result :Data);
    maxTxFee @17 (context :X.Context) -> (result :Int64);
    getPruneMode @18 (context :X.Context) -> (result :Bool);
    p2pEnabled @19 (context :X.Context) -> (result :Bool);
    isInitialBlockDownload @20 (context :X.Context) -> (result :Bool);
    shutdownRequested @21 (context :X.Context) -> (result :Bool);
    getAdjustedTime @22 (context :X.Context) -> (result :Int64);
    initMessage @23 (context :X.Context, message :Text) -> ();
    initWarning @24 (context :X.Context, message :Text) -> ();
    initError @25 (context :X.Context, message :Text) -> ();
    loadWallet @26 (context :X.Context, wallet :Wallet) -> ();
    showProgress @27 (context :X.Context, title :Text, progress :Int32, resumePossible :Bool) -> ();
    handleNotifications @28 (context :X.Context, notifications :ChainNotifications) -> (result :Handler);
    waitForNotifications @29 (context :X.Context) -> ();
    handleRpc @30 (context :X.Context, command :RPCCommand) -> (result :Handler);
}
...
interface ChainLock $X.proxy("interfaces::Chain::Lock") {
    ...
    findFirstBlockWithTime @8 (context :X.Context, time :Int64, wantHash :Bool) -> (hash :Data, result :Int32, hasResult :Bool);
    ...
    getTipLocator @13 (context :X.Context) -> (result :Data);
    ...
    submitToMemoryPool @16 (context :X.Context, tx :Data, absurdFee: Int64, state :ValidationState) -> (state :ValidationState, result :Bool);
}
...
interface ChainNotifications $X.proxy("interfaces::Chain::Notifications") {
    ...
    resendWalletTransactions @6 (context :X.Context, lockedChain :ChainLock, bestBlockTime :Int64) -> () $X.name("ResendWalletTransactions");
}
...
interface Node $X.proxy("interfaces::Node") {
    ...
    getBanned @23 (context :X.Context) -> (banmap :List(Pair(Data, Data)), result :Bool);
    ...
    getMaxTxFee @41 (context :X.Context) -> (result :Int64);
    estimateSmartFee @42 (context :X.Context, numBlocks :Int32, conservative :Bool, wantReturnedTarget :Bool) -> (returnedTarget :Int32, result :Data);
    getDustRelayFee @43 (context :X.Context) -> (result :Data);
    executeRpc @44 (context :X.Context, command :Text, params :UniValue, uri :Text) -> (error :Text $X.exception("std::exception"), rpcError :UniValue $X.exception("UniValue"), result :UniValue);
    listRpcCommands @45 (context :X.Context) -> (result :List(Text));
    rpcSetTimerInterfaceIfUnset @46 (context :X.Context, iface :Void) -> ();
    rpcUnsetTimerInterface @47 (context :X.Context, iface :Void) -> ();
    getUnspentOutput @48 (context :X.Context, output :Data) -> (coin :Data, result :Bool);
    getWalletDir @49 (context :X.Context) -> (result :Text);
    listWalletDir @50 (context :X.Context) -> (result :List(Text));
    getWallets @51 (context :X.Context) -> (result :List(Wallet));
    loadWallet @52 (context :X.Context, name :Text) -> (error :Text, warning: Text, result :Wallet);
    handleInitMessage @53 (context :X.Context, callback :InitMessageCallback) -> (result :Handler);
    handleMessageBox @54 (context :X.Context, callback :MessageBoxCallback) -> (result :Handler);
    handleQuestion @55 (context :X.Context, callback :QuestionCallback) -> (result :Handler);
    handleShowProgress @56 (context :X.Context, callback :ShowNodeProgressCallback) -> (result :Handler);
    handleLoadWallet @57 (context :X.Context, callback :LoadWalletCallback) -> (result :Handler);
    handleNotifyNumConnectionsChanged @58 (context :X.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler);
    handleNotifyNetworkActiveChanged @59 (context :X.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler);
    handleNotifyAlertChanged @60 (context :X.Context, callback :NotifyAlertChangedCallback) -> (result :Handler);
    handleBannedListChanged @61 (context :X.Context, callback :BannedListChangedCallback) -> (result :Handler);
    handleNotifyBlockTip @62 (context :X.Context, callback :NotifyBlockTipCallback) -> (result :Handler);
    handleNotifyHeaderTip @63 (context :X.Context, callback :NotifyHeaderTipCallback) -> (result :Handler);
}
...
interface Wallet $X.proxy("interfaces::Wallet") {
    ...
    getWalletTxDetails @38 (context :X.Context, txid :Data) -> (txStatus :WalletTxStatus, orderForm :List(Pair(Text, Text)), inMempool :Bool, numBlocks :Int32, result :WalletTx);
    ...
    remove @57 (context :X.Context) -> ();
    handleUnload @58 (context :X.Context, callback :UnloadWalletCallback) -> (result :Handler);
    handleShowProgress @59 (context :X.Context, callback :ShowWalletProgressCallback) -> (result :Handler);
    handleStatusChanged @60 (context :X.Context, callback :StatusChangedCallback) -> (result :Handler);
    handleAddressBookChanged @61 (context :X.Context, callback :AddressBookChangedCallback) -> (result :Handler);
    handleTransactionChanged @62 (context :X.Context, callback :TransactionChangedCallback) -> (result :Handler);
    handleWatchOnlyChanged @63 (context :X.Context, callback :WatchOnlyChangedCallback) -> (result :Handler);
    handleCanGetAddressesChanged @64 (context :X.Context, callback :CanGetAddressesChangedCallback) -> (result :Handler);
}
...
interface PendingWalletTx $X.proxy("interfaces::PendingWalletTx") {
    ...
    commit @2 (context :X.Context, valueMap :List(Pair(Text, Text)), orderForm :List(Pair(Text, Text))) -> (rejectReason :Text, result :Bool);
}
...
interface ActorCallback $X.proxy("ProxyCallback<CRPCCommand::Actor>") {
    call @0 (context :X.Context, request :JSONRPCRequest, response :UniValue, lastCallback :Bool) -> (error :Text $X.exception("std::exception"), rpcError :UniValue $X.exception("UniValue"), response :UniValue, result: Bool);
}
