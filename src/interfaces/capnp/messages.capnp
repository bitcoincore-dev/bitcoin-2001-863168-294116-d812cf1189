...
interface Node $X.proxy("interfaces::Node") {
    ...
    getWalletDir @47 (context :X.Context) -> (result :Text);
    listWalletDir @48 (context :X.Context) -> (result :List(Text));
    getWallets @49 (context :X.Context) -> (result :List(Wallet));
    handleInitMessage @50 (context :X.Context, callback :InitMessageCallback) -> (result :Handler);
    handleMessageBox @51 (context :X.Context, callback :MessageBoxCallback) -> (result :Handler);
    handleQuestion @52 (context :X.Context, callback :QuestionCallback) -> (result :Handler);
    handleShowProgress @53 (context :X.Context, callback :ShowNodeProgressCallback) -> (result :Handler);
    handleLoadWallet @54 (context :X.Context, callback :LoadWalletCallback) -> (result :Handler);
    handleNotifyNumConnectionsChanged @55 (context :X.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler);
    handleNotifyNetworkActiveChanged @56 (context :X.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler);
    handleNotifyAlertChanged @57 (context :X.Context, callback :NotifyAlertChangedCallback) -> (result :Handler);
    handleBannedListChanged @58 (context :X.Context, callback :BannedListChangedCallback) -> (result :Handler);
    handleNotifyBlockTip @59 (context :X.Context, callback :NotifyBlockTipCallback) -> (result :Handler);
    handleNotifyHeaderTip @60 (context :X.Context, callback :NotifyHeaderTipCallback) -> (result :Handler);
}
