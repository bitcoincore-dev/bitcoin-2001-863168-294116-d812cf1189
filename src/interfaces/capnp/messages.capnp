...
interface Chain $X.proxy("interfaces::Chain") {
    ...
    startShutdown @22 (context :X.Context) -> ();
    loadWallet @23 (context :X.Context, wallet :Wallet) -> ();
    generateBlocks @24 (context :X.Context, coinbaseScript :Data, numBlocks :Int32, maxTries:UInt64, keepScript:Bool) -> (result :UniValue);
    parseConfirmTarget @25 (context :X.Context, value :UniValue) -> (result :UInt32);
    handleNotifications @26 (context :X.Context, notifications :ChainNotifications) -> (result :Handler);
    waitForNotifications @27 (context :X.Context) -> ();
    handleRpc @28 (context :X.Context, command :RPCCommand) -> (result :Handler);
}
...
interface ChainNotifications $X.proxy("interfaces::Chain::Notifications") {
    ...
    inventory @6 (context :X.Context, hash :Data) -> () $X.name("Inventory");
    resendWalletTransactions @7 (context :X.Context, bestBlockTime :Int64) -> () $X.name("ResendWalletTransactions");
}
...
interface Node $X.proxy("interfaces::Node") {
    ...
    initLogging @8 (context :X.Context) -> ();
    initParameterInteraction @9 (context :X.Context) -> ();
    getWarnings @10 (context :X.Context, type :Text) -> (result :Text);
    getLogCategories @11 (context :X.Context) -> (result :UInt32);
    baseInitialize @12 (context :X.Context) -> (error :Text $X.exception("std::exception"), result :Bool);
    appInitMain @13 (context :X.Context) -> (error :Text $X.exception("std::exception"), result :Bool);
    appShutdown @14 (context :X.Context) -> ();
    startShutdown @15 (context :X.Context) -> ();
    shutdownRequested @16 (context :X.Context) -> (result :Bool);
    mapPort @17 (context :X.Context, useUPnP :Bool) -> ();
    getProxy @18 (context :X.Context, net :Int32) -> (proxyInfo :Proxy, result :Bool);
    getNodeCount @19 (context :X.Context, flags :Int32) -> (result :UInt64);
    getNodesStats @20 (context :X.Context) -> (stats :List(NodeStats), result :Bool);
    getBanned @21 (context :X.Context) -> (banmap :List(Pair(Data, Data)), result :Bool);
    ban @22 (context :X.Context, netAddr :Data, reason :Int32, banTimeOffset :Int64) -> (result :Bool);
    unban @23 (context :X.Context, ip :Data) -> (result :Bool);
    disconnect @24 (context :X.Context, id :Int64) -> (result :Bool);
    getTotalBytesRecv @25 (context :X.Context) -> (result :Int64);
    getTotalBytesSent @26 (context :X.Context) -> (result :Int64);
    getMempoolSize @27 (context :X.Context) -> (result :UInt64);
    getMempoolDynamicUsage @28 (context :X.Context) -> (result :UInt64);
    getHeaderTip @29 (context :X.Context) -> (height :Int32, blockTime :Int64, result :Bool);
    getNumBlocks @30 (context :X.Context) -> (result :Int32);
    getLastBlockTime @31 (context :X.Context) -> (result :Int64);
    getVerificationProgress @32 (context :X.Context) -> (result :Float64);
    isInitialBlockDownload @33 (context :X.Context) -> (result :Bool);
    getReindex @34 (context :X.Context) -> (result :Bool);
    getImporting @35 (context :X.Context) -> (result :Bool);
    setNetworkActive @36 (context :X.Context, active :Bool) -> ();
    getNetworkActive @37 (context :X.Context) -> (result :Bool);
    getMaxTxFee @38 (context :X.Context) -> (result :Int64);
    estimateSmartFee @39 (context :X.Context, numBlocks :Int32, conservative :Bool, wantReturnedTarget :Bool) -> (returnedTarget :Int32, result :Data);
    getDustRelayFee @40 (context :X.Context) -> (result :Data);
    executeRpc @41 (context :X.Context, command :Text, params :UniValue, uri :Text) -> (error :Text $X.exception("std::exception"), rpcError :UniValue $X.exception("UniValue"), result :UniValue);
    listRpcCommands @42 (context :X.Context) -> (result :List(Text));
    rpcSetTimerInterfaceIfUnset @43 (context :X.Context, iface :Void) -> ();
    rpcUnsetTimerInterface @44 (context :X.Context, iface :Void) -> ();
    getUnspentOutput @45 (context :X.Context, output :Data) -> (coin :Data, result :Bool);
    getWallets @46 (context :X.Context) -> (result :List(Wallet));
    handleInitMessage @47 (context :X.Context, callback :InitMessageCallback) -> (result :Handler);
    handleMessageBox @48 (context :X.Context, callback :MessageBoxCallback) -> (result :Handler);
    handleQuestion @49 (context :X.Context, callback :QuestionCallback) -> (result :Handler);
    handleShowProgress @50 (context :X.Context, callback :ShowNodeProgressCallback) -> (result :Handler);
    handleLoadWallet @51 (context :X.Context, callback :LoadWalletCallback) -> (result :Handler);
    handleNotifyNumConnectionsChanged @52 (context :X.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler);
    handleNotifyNetworkActiveChanged @53 (context :X.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler);
    handleNotifyAlertChanged @54 (context :X.Context, callback :NotifyAlertChangedCallback) -> (result :Handler);
    handleBannedListChanged @55 (context :X.Context, callback :BannedListChangedCallback) -> (result :Handler);
    handleNotifyBlockTip @56 (context :X.Context, callback :NotifyBlockTipCallback) -> (result :Handler);
    handleNotifyHeaderTip @57 (context :X.Context, callback :NotifyHeaderTipCallback) -> (result :Handler);
}
