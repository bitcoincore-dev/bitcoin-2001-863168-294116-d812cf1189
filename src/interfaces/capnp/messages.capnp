...
interface Chain $X.proxy("interfaces::Chain") {
    ...
    estimateMaxBlocks @13 (context :X.Context) -> (result :UInt32);
    ...
    handleNotifications @24 (context :X.Context, notifications :ChainNotifications) -> (result :Handler);
    waitForNotifications @25 (context :X.Context) -> ();
    handleRpc @26 (context :X.Context, command :RPCCommand) -> (result :Handler);
}
...
interface Node $X.proxy("interfaces::Node") {
    ...
    getWalletDir @46 (context :X.Context) -> (result :Text);
    listWalletDir @47 (context :X.Context) -> (result :List(Text));
    getWallets @48 (context :X.Context) -> (result :List(Wallet));
    handleInitMessage @49 (context :X.Context, callback :InitMessageCallback) -> (result :Handler);
    handleMessageBox @50 (context :X.Context, callback :MessageBoxCallback) -> (result :Handler);
    handleQuestion @51 (context :X.Context, callback :QuestionCallback) -> (result :Handler);
    handleShowProgress @52 (context :X.Context, callback :ShowNodeProgressCallback) -> (result :Handler);
    handleLoadWallet @53 (context :X.Context, callback :LoadWalletCallback) -> (result :Handler);
    handleNotifyNumConnectionsChanged @54 (context :X.Context, callback :NotifyNumConnectionsChangedCallback) -> (result :Handler);
    handleNotifyNetworkActiveChanged @55 (context :X.Context, callback :NotifyNetworkActiveChangedCallback) -> (result :Handler);
    handleNotifyAlertChanged @56 (context :X.Context, callback :NotifyAlertChangedCallback) -> (result :Handler);
    handleBannedListChanged @57 (context :X.Context, callback :BannedListChangedCallback) -> (result :Handler);
    handleNotifyBlockTip @58 (context :X.Context, callback :NotifyBlockTipCallback) -> (result :Handler);
    handleNotifyHeaderTip @59 (context :X.Context, callback :NotifyHeaderTipCallback) -> (result :Handler);
}
...
interface Wallet $X.proxy("interfaces::Wallet") {
    ...
    tryGetTxStatus @37 (context :X.Context, txid :Data) -> (txStatus :WalletTxStatus, numBlocks :Int32, result :Bool);
