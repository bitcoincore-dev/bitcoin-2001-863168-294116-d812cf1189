...
interface Chain $X.proxy("interfaces::Chain") {
    ...
    relayTransaction @9 (context :X.Context, txid :Data) -> ();
    ...
    mempoolMinFee @14 (context :X.Context) -> (result :Data);
    maxTxFee @15 (context :X.Context) -> (result :Int64);
    getPruneMode @16 (context :X.Context) -> (result :Bool);
    p2pEnabled @17 (context :X.Context) -> (result :Bool);
    isInitialBlockDownload @18 (context :X.Context) -> (result :Bool);
    getAdjustedTime @19 (context :X.Context) -> (result :Int64);
    initMessage @20 (context :X.Context, message :Text) -> ();
    initWarning @21 (context :X.Context, message :Text) -> ();
    initError @22 (context :X.Context, message :Text) -> ();
...
interface Wallet $X.proxy("interfaces::Wallet") {
    ...
    handleUnload @57 (context :X.Context, callback :UnloadWalletCallback) -> (result :Handler);
    handleShowProgress @58 (context :X.Context, callback :ShowWalletProgressCallback) -> (result :Handler);
    handleStatusChanged @59 (context :X.Context, callback :StatusChangedCallback) -> (result :Handler);
    handleAddressBookChanged @60 (context :X.Context, callback :AddressBookChangedCallback) -> (result :Handler);
    handleTransactionChanged @61 (context :X.Context, callback :TransactionChangedCallback) -> (result :Handler);
    handleWatchOnlyChanged @62 (context :X.Context, callback :WatchOnlyChangedCallback) -> (result :Handler);
    handleCanGetAddressesChanged @63 (context :X.Context, callback :CanGetAddressesChangedCallback) -> (result :Handler);
}
