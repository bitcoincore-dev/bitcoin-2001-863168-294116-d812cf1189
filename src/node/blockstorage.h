...
public:
    ...
    FlatFilePos SaveBlockToDisk(const CBlock& block, int nHeight, const Chainstate& chainstate, const CChainParams& chainparams, const FlatFilePos* dbp) EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
