 ...
 * deadlock.
 *
 * @param[in]  node reference to node state
 ...
 * return error
 */
NODISCARD TransactionError BroadcastTransaction(Node& node, CTransactionRef tx, std::string& err_string, const CAmount& max_tx_fee, bool relay, bool wait_callback);
