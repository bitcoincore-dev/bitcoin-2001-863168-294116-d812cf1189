...
interface Wallet $X.proxy("interface::Wallet") {
    ...
    getDefaultChangeType @48 () -> (result :Int32);
    handleShowProgress @49 (callback :ShowWalletProgressCallback) -> (result :Handler);
    handleStatusChanged @50 (callback :StatusChangedCallback) -> (result :Handler);
    handleAddressBookChanged @51 (callback :AddressBookChangedCallback) -> (result :Handler);
    handleTransactionChanged @52 (callback :TransactionChangedCallback) -> (result :Handler);
    handleWatchOnlyChanged @53 (callback :WatchOnlyChangedCallback) -> (result :Handler);
}
