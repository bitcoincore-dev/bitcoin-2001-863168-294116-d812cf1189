...
public:
    ...
    template <typename Context, typename Method, typename... Fields>
    kj::Promise<void> invokeMethodAsyncThread(AsyncThread& thread,
        Context& context,
        const Method& method,
        const Fields&... fields);
};
...
struct CapType<CapValue, Void<typename CapValue::Reads>>
{
    using Type = typename CapValue::Reads;
};
...
public:
    ...
    using MessageType = typename CapType<Plain<Reader>>::Type;
...
struct CapTraits<CapType, ::capnp::Kind::BLOB>
{
    template <typename Class>
...
template <typename CapType>
struct CapTraits<CapType, ::capnp::Kind::LIST>
{
    template <typename Class>
    using Setter = ::capnp::BuilderFor<CapType> (Class::*)(unsigned);
};
...
template <typename CapType>
struct CapTraits<CapType, ::capnp::Kind::STRUCT>
{
    template <typename Class>
