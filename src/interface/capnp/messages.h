...
template <>
class ProxyServerCustom<messages::ChainClient, Chain::Client> : public ProxyServerBase<messages::ChainClient, Chain::Client>
{
public:
    using ProxyServerBase<messages::ChainClient, Chain::Client>::ProxyServerBase;
    using ProxyServerBase<messages::ChainClient, Chain::Client>::invokeMethod;
    template <typename Method, typename... Fields>
    kj::Promise<void> invokeMethod(StartContext context, const Method&, const Fields&...)
    {
        return invokeMethod(kj::mv(context));
    }
    kj::Promise<void> invokeMethod(StartContext context);
