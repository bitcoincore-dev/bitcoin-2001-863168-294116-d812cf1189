...
public:
        ...
        std::string& reject_reason) override
    {
        ...
        if (!m_wallet.CommitTransaction(m_wtx, m_key, state)) {
...
WalletTx MakeWalletTx(interface::Chain::Lock& locked_chain, CWallet& wallet, const CWalletTx& wtx)
{
    WalletTx result;
    result.tx = wtx.tx;
...
WalletTxStatus MakeWalletTxStatus(interface::Chain::Lock& locked_chain, const CWalletTx& wtx)
{
...
WalletTxOut MakeWalletTxOut(interface::Chain::Lock& locked_chain,
    CWallet& wallet,
    const CWalletTx& wtx,
    int n,
    int depth)
...
public:
        ...
        std::string& fail_reason) override
    {
        ...
        if (!m_wallet.CreateTransaction(*locked_chain, recipients, pending->m_wtx, pending->m_key, fee, change_pos,
