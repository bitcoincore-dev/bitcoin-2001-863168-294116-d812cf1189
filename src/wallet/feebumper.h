...
{
public:
    CFeeBumper(interface::Chain::Lock& locked_chain, const CWallet *pWalletIn, const uint256 txidIn, const CCoinControl& coin_control, CAmount totalFee);
     ...
     */
    bool commit(interface::Chain::Lock& locked_chain, CWallet *pWalletNonConst);

private:
    bool preconditionChecks(interface::Chain::Lock& locked_chain, const CWallet *pWallet, const CWalletTx& wtx);
