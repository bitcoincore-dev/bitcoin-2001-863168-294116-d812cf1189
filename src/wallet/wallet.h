...
private:
    ...
    void SyncTransaction(interfaces::Chain::Lock& locked_chain, const CTransactionRef& tx, const uint256& block_hash, int posInBlock = 0) EXCLUSIVE_LOCKS_REQUIRED(cs_wallet);
