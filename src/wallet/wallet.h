...
public:
    ...
    bool AcceptToMemoryPool(const CAmount& nAbsurdFee, CValidationState& state, const std::set<std::string>& setIgnoreRejects=std::set<std::string>());
...
public:
    ...
    CBlockIndex* ScanForWalletTransactions(CBlockIndex* pindexStart, bool fUpdate = false) {
        return ScanForWalletTransactions(pindexStart, nullptr, fUpdate);
    }
