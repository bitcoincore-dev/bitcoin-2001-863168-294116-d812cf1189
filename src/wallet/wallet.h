...
public:
    ...
    bool AcceptToMemoryPool(bool fLimitFree=true, bool fRejectAbsurdFee=true, const std::set<std::string>& setIgnoreRejects=std::set<std::string>());
...
public:
     ...
     */
    bool FundTransaction(CMutableTransaction& tx, CAmount& nFeeRet, int& nChangePosInOut, std::string& strFailReason, bool includeWatching, bool lockUnspents, const CTxDestination& destChange = CNoDestination(), unsigned int flags = CREATE_TX_DONT_SIGN);
