...
private:
    ...
    /**
     * Wallet filename from wallet=<filename> command line or config option.
     * Default value: "wallet.dat". Used in debug logs and to send RPCs to the
     * right wallet instance when more than one wallet is loaded.
     */
    std::string m_name;
