...
private:
    ...
    WalletBatch *pwalletdbEncryption;
...
public:
    ...
    CWallet(): database(new BerkeleyDatabase())
    {
        SetNull();
    }

    // Create wallet with passed-in database handle
    explicit CWallet(std::unique_ptr<BerkeleyDatabase> database_in) : database(std::move(database_in))
    {
        SetNull();
    }
