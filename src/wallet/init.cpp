...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-wallet=<file>", _("Specify wallet file path. Can be specified multiple times to load multiple wallets. Path is interpreted relative to the data directory if it is not absolute.") + " " + strprintf(_("(default: %s)"), DEFAULT_WALLET_DAT));
