...
public:
    ...
    virtual TransactionError FillPSBT(PartiallySignedTransaction& psbt, PrecomputedTransactionData& txdata, int sighash_type = SIGHASH_DEFAULT, bool sign = true, bool bip32derivs = false, int* n_signed = nullptr, bool finalize = true) const { return TransactionError::INVALID_PSBT; }
...
public:
    ...
    TransactionError FillPSBT(PartiallySignedTransaction& psbt, PrecomputedTransactionData& txdata, int sighash_type = SIGHASH_DEFAULT, bool sign = true, bool bip32derivs = false, int* n_signed = nullptr, bool finalize = true) const override;
