...
bool BerkeleyEnvironment::Open(const fs::path& pathIn, bool retry)
{
    if (fDbEnvInit)
        return true;
...
bool BerkeleyBatch::VerifyEnvironment(const std::string& walletFile, const fs::path& walletDir, std::string& errorStr)
{
...
bool BerkeleyBatch::VerifyDatabaseFile(const std::string& walletFile, const fs::path& walletDir, std::string& warningStr, std::string& errorStr, BerkeleyEnvironment::recoverFunc_type recoverFunc)
{
