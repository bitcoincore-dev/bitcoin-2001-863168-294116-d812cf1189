...
static void SendMoney(CWallet * const pwallet, const CTxDestination &address, CAmount nValue, bool fSubtractFeeFromAmount, mapValue_t mapValue, std::string fromAccount, CTransactionRef& txNew)
{
