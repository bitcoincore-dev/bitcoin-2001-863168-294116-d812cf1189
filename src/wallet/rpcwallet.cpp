...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    SendMoney(pwallet, dest, nAmount, fSubtractFeeFromAmount, coin_control, std::move(mapValue), {} /* fromAccount */, txNew);
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    CTransactionRef txNew;
    SendMoney(pwallet, dest, nAmount, false, no_coin_control, std::move(mapValue), std::move(strAccount), txNew);
