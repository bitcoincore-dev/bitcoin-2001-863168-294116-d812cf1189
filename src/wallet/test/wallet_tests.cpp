...
static const CWallet testWallet(testChain.get(), MakeUnique<CWalletDBWrapper>());
...
public:
    ListCoinsTestingSetup()
    {
        ...
        wallet.reset(new CWallet(m_chain.get(), std::unique_ptr<CWalletDBWrapper>(new CWalletDBWrapper(&bitdb, "wallet_test.dat"))));
        bool firstRun;
