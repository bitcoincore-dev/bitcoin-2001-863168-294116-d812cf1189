...
uint256 CWallet::ScanForWalletTransactions(const uint256& start_block, const uint256& stop_block, const WalletRescanReserver &reserver, bool fUpdate)
{
...

    {
        ...
        double progress_end;
        {
            ...
            progress_begin = m_chain->guessVerificationProgress(block_hash);
            if (stop_block.IsNull()) {
                progress_end = m_chain->guessVerificationProgress(tip_hash);
            } else {
                progress_end = m_chain->guessVerificationProgress(stop_block);
            }
        }
        ...
        while (block_height && !fAbortRescan && !ShutdownRequested())
        {
            ...
            }
            {
                ...
                progress_current = m_chain->guessVerificationProgress(block_hash);
