...
bool WalletBatch::VerifyEnvironment(const std::string& walletFile, const fs::path& walletDir, std::string& errorStr)
{
    return BerkeleyBatch::VerifyEnvironment(walletFile, walletDir, errorStr);
}

bool WalletBatch::VerifyDatabaseFile(const std::string& walletFile, const fs::path& walletDir, std::string& warningStr, std::string& errorStr)
{
    return BerkeleyBatch::VerifyDatabaseFile(walletFile, walletDir, warningStr, errorStr, WalletBatch::Recover);
}
