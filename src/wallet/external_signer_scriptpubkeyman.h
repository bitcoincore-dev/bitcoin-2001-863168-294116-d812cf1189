...
class ExternalSignerScriptPubKeyMan : public DescriptorScriptPubKeyMan
{
  ...
  */
  ...
  TransactionError FillPSBT(PartiallySignedTransaction& psbt, PrecomputedTransactionData& txdata, int sighash_type = 1 /* SIGHASH_ALL */, bool sign = true, bool bip32derivs = false, int* n_signed = nullptr, bool finalize = true) const override;
};
