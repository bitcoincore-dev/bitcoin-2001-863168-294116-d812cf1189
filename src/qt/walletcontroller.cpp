...
void CreateWalletActivity::finish()
{
    ...
    if (!m_error_message.original.empty()) {
        ...
        QMessageBox::warning(m_parent_widget, tr("Create wallet warning"), QString::fromStdString(Join(m_warning_message, std::string("\n"), OpTranslated)));
    }
...
void OpenWalletActivity::finish()
{
    ...
    if (!m_error_message.original.empty()) {
        ...
        QMessageBox::warning(m_parent_widget, tr("Open wallet warning"), QString::fromStdString(Join(m_warning_message, std::string("\n"), OpTranslated)));
    }
