...
private:
    ...
    bool executeConsoleGenerate(const std::vector<std::string>& parsed_command, const WalletModel* wallet_model);
    bool executeConsoleHelpGenerate(const std::vector<std::string>& parsed_command, const WalletModel* wallet_model);
    ...
    std::map<std::string, bool (RPCExecutor::*)(const std::vector<std::string>&, const WalletModel*)> m_method_map{
        ...
        {"help generate", &RPCExecutor::executeConsoleHelpGenerate},
 ...
 */
bool commandMatches(const std::vector<std::string>& parsed_command, const std::string& key)
{
...
bool RPCExecutor::executeConsoleOnlyCommand(const std::string& command, const WalletModel* wallet_model)
{
    ...
    // Returns false if no command was caught by previous code
    return false;
}
