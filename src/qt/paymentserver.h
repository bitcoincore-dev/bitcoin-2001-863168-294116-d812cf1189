...
public:
    ...
    static void ipcParseCommandLine(ipc::Node& ipcNode, int argc, char *argv[]);
    ...
    static bool verifyNetwork(ipc::Node& ipcNode, const payments::PaymentDetails& requestDetails);
