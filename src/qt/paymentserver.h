...
public:
    ...
    static void ipcParseCommandLine(ipc::Node& ipc_node, int argc, char *argv[]);
    ...
    static bool verifyNetwork(ipc::Node& ipc_node, const payments::PaymentDetails& requestDetails);
...
public Q_SLOTS:
    ...
    void fetchPaymentACK(WalletModel* walletModel, SendCoinsRecipient recipient, QByteArray transaction);
