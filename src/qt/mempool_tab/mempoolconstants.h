...
bool const MEMPOOL_GRAPH_LOGGING                 = false;//false;
bool const MEMPOOL_GRAPH_TXCOUNT_LOGGING         = false;//true;
bool const MEMPOOL_GRAPH_CROSS_PATH_LOGGING      = false;//false;
bool const MEMPOOL_GRAPH_FEEPATH_LOGGING         = false;//false;
bool const MEMPOOL_GRAPH_SINGLE_CLICK_LOGGING    = false;//true;
bool const MEMPOOL_GRAPH_DOUBLE_CLICK_LOGGING    = false;//true;
bool const MEMPOOL_GRAPH_RESIZE_EVENT_LOGGING    = false;//true;
bool const MEMPOOL_GRAPH_MOUSE_EVENT_LOGGING     = false;//true;
bool const MEMPOOL_GRAPH_STEPBASE_LOGGING        = false;//true;
bool const MEMPOOL_GRAPH_HORZLINES_LOGGING       = false;//true;
bool const MEMPOOL_HORZ_LINE_LOGGING             = false;//true;
bool const MEMPOOL_CLIENT_MODEL_LOGGING          = false;//true;
bool const MEMPOOL_DETAIL_LOGGING                = false;//false;
