...
bool WalletModel::bumpFee(uint256 hash)
{
    ...
    if (FeeBumper::CreateTransaction(wallet, hash, ::nTxConfirmTarget, false /* ignoreignoreGlobalPayTxFee, */, 0 /* totalFee, */, true /* replaceable, */, errors, oldFee, newFee, mtx) != BumpFeeResult::OK) {
