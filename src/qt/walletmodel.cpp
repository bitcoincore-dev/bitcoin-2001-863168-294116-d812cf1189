...
bool WalletModel::bumpFee(uint256 hash)
{
    ...
    if (FeeBumper::CreateTransaction(wallet, hash, ::nTxConfirmTarget, false /* ignoreGlobalPayTxFee */, 0 /* totalFee */, true /* replaceable */, FeeEstimateMode::UNSET, errors, oldFee, newFee, mtx) != BumpFeeResult::OK) {
