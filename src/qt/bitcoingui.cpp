...
void BitcoinGUI::createActions()
{
    ...
    overviewAction->setShortcut(QKeySequence(tr("Alt+1")));
    ...
    sendCoinsAction->setShortcut(QKeySequence(tr("Alt+2")));
    ...
    receiveCoinsAction->setShortcut(QKeySequence(tr("Alt+3")));
    ...
    historyAction->setShortcut(QKeySequence(tr("Alt+4")));
