...
void BitcoinGUI::createActions()
{
    ...
    overviewAction->setShortcut(QKeySequence(QString{"Alt+1"}));
    ...
    sendCoinsAction->setShortcut(QKeySequence(QString{"Alt+2"}));
    ...
    receiveCoinsAction->setShortcut(QKeySequence(QString{"Alt+3"}));
    ...
    historyAction->setShortcut(QKeySequence(QString{"Alt+4"}));
