...
public:
    ...
    void refreshPeers(ipc::Node& ipc_node)
    {
        {
            cachedNodeStats.clear();

            ipc::Node::NodesStats nodes;
            ipc_node.getNodesStats(nodes);
...
PeerTableModel::PeerTableModel(ipc::Node& ipc_node, ClientModel *parent) :
