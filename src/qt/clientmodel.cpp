...
void ClientModel::updateTimer()
{
    ...
    Q_EMIT mempoolSizeChanged(ipcNode.getMempoolSize(), ipcNode.getMempoolDynamicUsage());
    Q_EMIT bytesChanged(ipcNode.getTotalBytesRecv(), ipcNode.getTotalBytesSent());
}
