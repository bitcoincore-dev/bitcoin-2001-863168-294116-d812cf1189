...
See [build instructions](/doc/README.md#Building).
...
- Contains translations. They are periodically updated and an effort is made to support as many languages as possible. The process of contributing translations is described in [translation_process.md](/doc/devel/translation_process.md).
...
**Note:** Do not change `local/bitcoin_en.ts`. It is updated [automatically](/doc/devel/translation_process.md#writing-code-with-translations).
