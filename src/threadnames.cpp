...
#if (defined(WIN32) || !defined(HAVE_THREAD_LOCAL))
#define CANT_USE_THREAD_LOCAL
#endif

#ifdef CANT_USE_THREAD_LOCAL
...
std::string ThreadNameRegistry::GetId()
{
    ...
    // When using this implementation, Win32 throws mysterious stack traces and unhandled page faults.
    // Something might be off with their thread_local or mutex implementations.
    //
    // See https://gist.github.com/jamesob/fe9a872051a88b2025b1aa37bfa98605
    //
