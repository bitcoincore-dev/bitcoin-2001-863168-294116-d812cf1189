...
void CTxMemPool::UpdateForDescendants(txiter updateIt, cacheMap& cachedDescendants,
                                      ...
                                      int32_t ancestor_size_limit, uint64_t ancestor_count_limit)
{
...
void CTxMemPool::UpdateTransactionsFromBlock(const std::vector<uint256> &vHashesToUpdate, int32_t ancestor_size_limit, uint64_t ancestor_count_limit)
{
    AssertLockHeld(cs);
