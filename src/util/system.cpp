 ...
 */
bool InterpretNegated(std::string& key, std::string& key_name)
{
    assert(key[0] == '-');
...
bool CheckValue(const std::string& key, const std::string& value, bool negated, unsigned int flags, std::string& error)
{
