...
public:
    CMainParams() {
        ...
        m_assumeutxo_data = {
            {
                .height = 788'000,
                .hash_serialized = AssumeutxoHash{uint256S("0xc5b9112c9260c9978c8df20b6500a074a6d416a1a1ad41ebfb83e4da12c40e49")},
                .nChainTx = 831210063,
                .blockhash = uint256S("0x00000000000000000001f3fa1b4c03c877740778f56b0d5456b18dd88f7f695e")
            },
        };
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        m_assumeutxo_data = {
            {
                .height = 0,
                .hash_serialized = AssumeutxoHash{uint256S("0xe8e5dcc60dfee8cf522a7f68a0cc75ad453dfc093ca337f679ab6e32ec8e875c")},
                .nChainTx = 1,
                .blockhash = uint256S("0x0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206")
            },
            {
                .height = 110,
