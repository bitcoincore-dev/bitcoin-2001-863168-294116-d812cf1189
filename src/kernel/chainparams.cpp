...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000527518a6a06b395192fafe40");
        consensus.defaultAssumeValid = uint256S("0x000000000000000000003d97a46dbbb4cca4b3e23c39c446df75cfe726163bb5"); // 803584
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 000000000000000000000df1509875e433c047e0ba00b109d181b3683e7d0c03
            .nTime    = 1692305372,
            .nTxCount = 880711311,
            .dTxRate  = 5.385028425730747,
        };
    }
};
