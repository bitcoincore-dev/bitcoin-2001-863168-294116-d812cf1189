...
BOOST_AUTO_TEST_CASE(chainstatemanager)
{
    ...
    BOOST_CHECK_EQUAL(WITH_LOCK(::cs_main, return manager.ActiveHeight()), -1);

    auto active_tip = WITH_LOCK(::cs_main, return manager.ActiveTip());
    ...
    BOOST_CHECK_EQUAL(WITH_LOCK(::cs_main, return manager.ActiveHeight()), 0);

    auto active_tip2 = WITH_LOCK(::cs_main, return manager.ActiveTip());
...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_loadblockindex, TestChain100Setup)
{
    ...
    CBlockIndex* assumed_tip{WITH_LOCK(::cs_main, return chainman.ActiveChain().Tip())};
