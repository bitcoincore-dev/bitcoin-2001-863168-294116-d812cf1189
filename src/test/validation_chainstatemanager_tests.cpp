...
BOOST_AUTO_TEST_CASE(chainstatemanager_rebalance_caches)
{
    ...
    BOOST_CHECK_EQUAL(c1.m_coinstip_cache_size_bytes, max_cache * 0.05);
    BOOST_CHECK_EQUAL(c1.m_coinsdb_cache_size_bytes, max_cache * 0.05);
    BOOST_CHECK_EQUAL(c2.m_coinstip_cache_size_bytes, max_cache * 0.95);
    BOOST_CHECK_EQUAL(c2.m_coinsdb_cache_size_bytes, max_cache * 0.95);
