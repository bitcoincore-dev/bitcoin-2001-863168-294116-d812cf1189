...
BOOST_FIXTURE_TEST_CASE(util_CheckValue, CheckValueTest)
{
    ...
    CheckValue(ArgsManager::TYPE_STRING, "-value=", Expect{}.String(DEFAULT_STRING));
    CheckValue(ArgsManager::TYPE_STRING, "-value=0", Expect{}.String("0").Bool(true));
    CheckValue(ArgsManager::TYPE_STRING, "-value=1", Expect{}.String("1").Bool(true));
    CheckValue(ArgsManager::TYPE_STRING, "-value=2", Expect{}.String("2").Bool(true));
    CheckValue(ArgsManager::TYPE_STRING, "-value=abc", Expect{}.String("abc").Bool(true));
    ...
    CheckValue(ArgsManager::TYPE_OPTIONAL_STRING, "-value=", Expect{}.String(DEFAULT_STRING));
    ...
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-novalue", Expect{}.Many({}).Bool(false));
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-novalue=0", Expect{}.Error("Can not negate -value at the same time as setting value '0'"));
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-novalue=1", Expect{}.Many({}).Bool(false));
    ...
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-value=", Expect{}.Many({""}).Bool(true));
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-value=0", Expect{}.Many({"0"}).Bool(true));
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-value=1", Expect{}.Many({"1"}).Bool(true));
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-value=2", Expect{}.Many({"2"}).Bool(true));
    CheckValue(ArgsManager::TYPE_STRING_LIST, "-value=abc", Expect{}.Many({"abc"}).Bool(true));
    ...
    CheckValue(ArgsManager::TYPE_INT, "-value=", Expect{}.Int(DEFAULT_INT));
...
{
    TestArgsManager testArgs;
    const auto a = std::make_pair("-a", ArgsManager::TYPE_BOOL);
    const auto b = std::make_pair("-b", ArgsManager::TYPE_BOOL);
    const auto c = std::make_pair("-c", ArgsManager::TYPE_BOOL);
    const auto d = std::make_pair("-d", ArgsManager::TYPE_BOOL);
...
{
    TestArgsManager test_args;
    const auto testnet = std::make_pair("-testnet", ArgsManager::TYPE_BOOL);
    const auto regtest = std::make_pair("-regtest", ArgsManager::TYPE_BOOL);
