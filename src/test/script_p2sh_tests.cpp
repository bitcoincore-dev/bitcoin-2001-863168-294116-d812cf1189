...
{
    return IsStandardTx(tx, std::nullopt, DEFAULT_PERMIT_BAREPUBKEY, permit_bare_multisig, /*reject_tokens=*/false, CFeeRate{DUST_RELAY_TX_FEE}, reason);
}

static bool IsStandardTx(const CTransaction& tx, std::string& reason)
{
    return IsStandardTx(tx, std::nullopt, DEFAULT_PERMIT_BAREPUBKEY, /*permit_bare_multisig=*/true, /*reject_tokens=*/false, CFeeRate{DUST_RELAY_TX_FEE}, reason) &&
           IsStandardTx(tx, std::nullopt, DEFAULT_PERMIT_BAREPUBKEY, /*permit_bare_multisig=*/false, /*reject_tokens=*/false, CFeeRate{DUST_RELAY_TX_FEE}, reason);
}
