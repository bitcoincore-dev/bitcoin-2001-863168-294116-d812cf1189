...
void InsertCoinsMapEntry(CCoinsMap& map, CAmount value, char flags)
{
    if (value == ABSENT) {
...
BOOST_AUTO_TEST_CASE(ccoins_modify_new)
{
    ...
    CheckModifyNewCoins(VALUE1, PRUNED, ERROR , 0          , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, PRUNED, PRUNED, 0          , DIRTY      , true );
    CheckModifyNewCoins(VALUE1, PRUNED, ERROR , FRESH      , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, PRUNED, ABSENT, FRESH      , NO_ENTRY   , true );
    CheckModifyNewCoins(VALUE1, PRUNED, ERROR , DIRTY      , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, PRUNED, PRUNED, DIRTY      , DIRTY      , true );
    CheckModifyNewCoins(VALUE1, PRUNED, ERROR , DIRTY|FRESH, NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, PRUNED, ABSENT, DIRTY|FRESH, NO_ENTRY   , true );
    CheckModifyNewCoins(VALUE1, VALUE2, ERROR , 0          , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, VALUE2, VALUE2, 0          , DIRTY      , true );
    CheckModifyNewCoins(VALUE1, VALUE2, ERROR , FRESH      , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, VALUE2, VALUE2, FRESH      , DIRTY|FRESH, true );
    CheckModifyNewCoins(VALUE1, VALUE2, ERROR , DIRTY      , NO_ENTRY   , false);
    CheckModifyNewCoins(VALUE1, VALUE2, VALUE2, DIRTY      , DIRTY      , true );
    CheckModifyNewCoins(VALUE1, VALUE2, ERROR , DIRTY|FRESH, NO_ENTRY   , false);
