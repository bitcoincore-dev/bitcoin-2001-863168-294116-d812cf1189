...
void test_one_input(const std::vector<uint8_t>& buffer)
{
    ...
    for (int i = 0; i < num_peers_to_add; ++i) {
        ...
        peers.push_back(MakeUnique<CNode>(i, service_flags, 0, INVALID_SOCKET, CAddress{CService{in_addr{0x0100007f}, 7777}, NODE_NETWORK}, 0, 0, std::string{}, conn_type).release());
