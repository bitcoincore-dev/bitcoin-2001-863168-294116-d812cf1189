...
FUZZ_TARGET(transaction, .init = initialize_transaction)
{
    ...
    std::string reason;
    const bool is_standard_with_permit_bare_multisig = IsStandardTx(tx, std::nullopt, /* permit_bare_pubkey= */ true, /* permit_bare_multisig= */ true, /*reject_tokens=*/false, dust_relay_fee, reason);
    const bool is_standard_without_permit_bare_multisig = IsStandardTx(tx, std::nullopt, /* permit_bare_pubkey= */ true, /* permit_bare_multisig= */ false, /*reject_tokens=*/false, dust_relay_fee, reason);
