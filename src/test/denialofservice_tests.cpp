...
BOOST_AUTO_TEST_CASE(outbound_slow_chain_eviction)
{
    ...
    CNode dummyNode1(id++, ServiceFlags(NODE_NETWORK | NODE_WITNESS), 0, INVALID_SOCKET, addr1, 0, 0, "", ConnectionType::OUTBOUND_FULL_RELAY);
...
static void AddRandomOutboundPeer(std::vector<CNode *> &vNodes, PeerManager &peerLogic, CConnmanTest* connman)
{
    ...
    vNodes.emplace_back(new CNode(id++, ServiceFlags(NODE_NETWORK | NODE_WITNESS), 0, INVALID_SOCKET, addr, 0, 0, "", ConnectionType::OUTBOUND_FULL_RELAY));
...
BOOST_AUTO_TEST_CASE(peer_discouragement)
{
    ...
    banman->ClearBanned();
    CAddress addr1(ip(0xa0b0c001), NODE_NONE);
    CNode dummyNode1(id++, NODE_NETWORK, 0, INVALID_SOCKET, addr1, 0, 0, "", ConnectionType::INBOUND);
    dummyNode1.SetCommonVersion(PROTOCOL_VERSION);
    peerLogic->InitializeNode(&dummyNode1);
    dummyNode1.nVersion = 1;
    dummyNode1.fSuccessfullyConnected = true;
    ...
    CNode dummyNode2(id++, NODE_NETWORK, 0, INVALID_SOCKET, addr2, 1, 1, "", ConnectionType::INBOUND);
...
BOOST_AUTO_TEST_CASE(DoS_bantime)
{
    ...
    CNode dummyNode(id++, NODE_NETWORK, 0, INVALID_SOCKET, addr, 4, 4, "", ConnectionType::INBOUND);
