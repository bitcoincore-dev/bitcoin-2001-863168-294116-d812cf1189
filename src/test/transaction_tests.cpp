...
BOOST_AUTO_TEST_CASE(test_IsStandard)
{
    ...
    const auto CheckIsStandard = [&](const auto& t) {
        std::string reason;
        BOOST_CHECK(IsStandardTx(CTransaction{t}, MAX_OP_RETURN_RELAY, g_bare_pubkey, g_bare_multi, /*reject_parasites=*/ false, /*reject_tokens=*/reject_tokens, g_dust, reason));
