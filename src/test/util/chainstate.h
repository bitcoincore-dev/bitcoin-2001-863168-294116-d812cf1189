 ...
 * conditions tha would otherwise cause shutdowns based on the IBD chainstate going
...
{
    NodeContext& node = fixture->m_node;
    ...
    if (reset_chainstate) {
        ...
        BOOST_CHECK_EQUAL(node.chainman->ActiveTip()->nHeight, 0);
    }
