...
BOOST_AUTO_TEST_CASE(cnode_simple_test)
{
    ...
    std::unique_ptr<CNode> pnode1 = MakeUnique<CNode>(id++, NODE_NETWORK, height, hSocket, addr, 0, 0, pszDest, ConnectionType::OUTBOUND_FULL_RELAY);
    ...
    std::unique_ptr<CNode> pnode2 = MakeUnique<CNode>(id++, NODE_NETWORK, height, hSocket, addr, 1, 1, pszDest, ConnectionType::INBOUND);
...
BOOST_AUTO_TEST_CASE(ipv4_peer_with_ipv6_addrMe_test)
{
    ...
    std::unique_ptr<CNode> pnode = MakeUnique<CNode>(0, NODE_NETWORK, 0, INVALID_SOCKET, addr, 0, 0, std::string{}, ConnectionType::OUTBOUND_FULL_RELAY);
