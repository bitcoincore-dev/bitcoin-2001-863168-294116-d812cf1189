...
public:
    explicit CChainState(BlockManager& blockman, uint256 from_snapshot_blockhash = uint256(), int script_threads = 0);
...
public:
    ...
    //! @param[in] script_threads       Number of additional script checking
    //!                                 worker threads.
