...
protected:
    ...
    //! longer connect blocks to the background chainstate - it does *not* indicate
    //! that the background chainstate has been used to fully validate the snapshot.
    //!
    //! It may also be set for snapshot chainstates found to be invalid.
