...
public:
    ...
    /**
     * Initialize the CoinsViews UTXO set management data structures.
     *
    ...
    //! @returns whether or not the CoinsViews object has been initialized.
    bool HasCoinsViews() {
        return m_coins_views != nullptr;
    }
