...
private:
    ...
    bool IsUsable(const CChainState* const cs) const EXCLUSIVE_LOCKS_REQUIRED(::cs_main) {
...
public:
    ...
    {
        return m_snapshot_chainstate && m_ibd_chainstate && m_ibd_chainstate->m_stop_use;
    }
