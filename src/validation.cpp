...
CChainState::CChainState(BlockManager& blockman, uint256 from_snapshot_blockhash, int script_check_worker_threads)
    : m_blockman(blockman),
...
CChainState& ChainstateManager::InitializeChainstate(const uint256& snapshot_blockhash, int script_check_worker_threads)
{
    ...
    to_modify.reset(new CChainState(m_blockman, snapshot_blockhash, script_check_worker_threads));
