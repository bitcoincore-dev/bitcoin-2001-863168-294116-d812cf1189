...
CChainState::CChainState(BlockManager& blockman, uint256 from_snapshot_blockhash, int script_threads)
    : m_blockman(blockman),
      m_parallel_script_checks{script_threads >= 1},
      m_script_check_queue{MakeUnique<CCheckQueue<CScriptCheck>>(128 /* batch size */, script_threads)},
