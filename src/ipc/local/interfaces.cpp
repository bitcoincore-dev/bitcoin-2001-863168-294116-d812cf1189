...
public:
        ...
        CMutableTransaction& mtx)
    {
        return FeeBumper::CreateTransaction(&m_wallet, txid, confirm_target, ignore_global_pay_tx_fee, total_fee,
                   replaceable, errors, old_fee, new_fee, mtx) == BumpFeeResult::OK;
    }
...
public:
    ...
    CAmount getMinimumFee(unsigned int tx_bytes, int confirm_target) override
    {
        CHECK_WALLET(return CWallet::GetMinimumFee(tx_bytes, confirm_target, ::mempool, ::feeEstimator));
    }
    CAmount getMaxTxFee() override { return ::maxTxFee; }
    CFeeRate estimateSmartFee(int num_blocks, int* answer_found_at_blocks = nullptr) override
    {
        FeeCalculation fee_calc;
        CFeeRate result = ::feeEstimator.estimateSmartFee(num_blocks, &fee_calc, ::mempool);
