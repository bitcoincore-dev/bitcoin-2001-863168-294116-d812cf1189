...
public:
    ...
    //! Get minimum fee.
    virtual CAmount getMinimumFee(unsigned int tx_bytes, int confirm_target) = 0;

    //! Get max tx fee.
    virtual CAmount getMaxTxFee() = 0;

    //! Estimate smart fee.
    virtual CFeeRate estimateSmartFee(int num_blocks, int* answer_found_at_blocks = nullptr) = 0;
...
public:
    ...
    // Get key from pool.
    virtual bool getKeyFromPool(CPubKey& pub_key, bool internal = false) = 0;
