...
interface Chain $Proxy.wrap("interfaces::Chain") {
    ...
    checkChainLimits @25 (context :Proxy.Context, tx :Data) -> (result :Bool);
    ...
    rpcSerializationWithoutWitness @45 (context :Proxy.Context) -> (result :Bool);
    ...
    updateRwSetting @49 (context :Proxy.Context, name :Text, value :Text, write :Bool) -> (result :Bool);
