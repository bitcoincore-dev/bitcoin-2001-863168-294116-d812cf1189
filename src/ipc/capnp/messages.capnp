...
interface Node {
    ...
    getMinimumFee @39 (txBytes :UInt32, confirmTarget :Int32) -> (result :Int64);
    getMaxTxFee @40 () -> (result :Int64);
    estimateSmartFee @41 (numBlocks :Int32) -> (answerFoundAtBlocks :Int32, result :Data);
    ...
    getWallet @51 (index: Int64) -> (result :Wallet);
...
interface Wallet {
    ...
    transactionCanBeBumped @27 (txid :Data) -> (value :Bool);
    createBumpTransaction @28 (txid :Data, confirmTarget :Int32, ignoreGlobalPayTxFee :Bool, totalFee :Int64, replaceable :Bool) -> (errors :List(Text), oldFee :Int64, newFee :Int64, mtx :Data, value :Bool);
    signBumpTransaction @29 (mtx :Data) -> (mtx :Data, value :Bool);
    commitBumpTransaction @30 (txid :Data, mtx :Data) -> (errors :List(Text), bumpedTxid :Data, value :Bool);
