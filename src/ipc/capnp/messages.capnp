...
interface Wallet {
    ...
    transactionCanBeBumped @27 (txHash :Data) -> (value :Bool);
    createBumpTransaction @28 (txHash :Data, confirmTarget :Int32, ignoreUserSetFee :Bool, totalFee :Int64, replaceable :Bool) -> (errors :List(Text), oldFee :Int64, newFee :Int64, mtx :Data, value :Bool);
    signBumpTransaction @29 (mtx :Data) -> (mtx :Data, value :Bool);
    commitBumpTransaction @30 (txHash :Data, mtx :Data) -> (errors :List(Text), bumpedTxHash :Data, value :Bool);
    getTx @31 (txHash :Data) -> (result :Data);
    getWalletTx @32 (txHash :Data) -> (result :WalletTx);
    getWalletTxs @33 () -> (result :List(WalletTx));
    tryGetTxStatus @34 (txHash :Data) -> (txStatus :WalletTxStatus, numBlocks :Int32, adjustedTime :Int64, result :Bool);
    getWalletTxDetails @35 (txHash :Data) -> (txStatus :WalletTxStatus, orderForm :WalletOrderForm, inMempool :Bool, numBlocks :Int32, adjustedTime :Int64, result :WalletTx);
    ...
    getUnconfirmedBalance @39 () -> (result :Int64);
    getImmatureBalance @40 () -> (result :Int64);
    getWatchOnlyBalance @41 () -> (result :Int64);
    getUnconfirmedWatchOnlyBalance @42 () -> (result :Int64);
    getImmatureWatchOnlyBalance @43 () -> (result :Int64);
    getAvailableBalance @44 (coinControl :CoinControl) -> (result :Int64);
    isMine @45 (txin :Data, txout :Data) -> (result :Int32);
    getDebit @46 (txin :Data, filter :Int32) -> (result :Int64);
    getCredit @47 (txout :Data, filter :Int32) -> (result :Int64);
    listCoins @48 () -> (result :CoinsList);
    getCoins @49 (outputs :List(Data)) -> (result :List(WalletTxOut));
    hdEnabled @50 () -> (result :Bool);
    handleShowProgress @51 (callback: ShowProgressCallback) -> (handler :Handler);
    handleStatusChanged @52 (callback: StatusChangedCallback) -> (handler :Handler);
    handleAddressBookChanged @53 (callback: AddressBookChangedCallback) -> (handler :Handler);
    handleTransactionChanged @54 (callback: TransactionChangedCallback) -> (handler :Handler);
    handleWatchonlyChanged @55 (callback: WatchonlyChangedCallback) -> (handler :Handler);
}
