...
void BuildCoinControl(messages::CoinControl::Builder&& builder, const CCoinControl& coin_control)
{
    ...
    builder.setFeeRate(ToArray(Serialize(coin_control.nFeeRate)));
    builder.setConfirmTarget(coin_control.nConfirmTarget);
...
void ReadCoinControl(CCoinControl& coin_control, const messages::CoinControl::Reader& reader)
{
    ...
    Unserialize(coin_control.nFeeRate, reader.getFeeRate());
    coin_control.nConfirmTarget = reader.getConfirmTarget();
