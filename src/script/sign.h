...
public:
    ...
    MutableTransactionSignatureCreator(const CMutableTransaction* tx, unsigned int input_idx, const CAmount& amount, PrecomputedTransactionData* txdata, int hash_type);
