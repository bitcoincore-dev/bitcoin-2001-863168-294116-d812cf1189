...
static void ReadConfigFile(boost::filesystem::ifstream& streamConfig, std::set<std::string>* setAllowOverride, std::set<std::string>* setInitiallyAssigned)
{
...
{
    boost::filesystem::ifstream streamConfig(GetConfigFile(mainconfPath));
    ReadConfigFile(streamConfig, NULL, &setConfigAssigned);
}
