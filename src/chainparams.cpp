...
public:
    CMainParams() {
        ...
        // FIXME BIP number
        consensus.vDeployments[Consensus::DEPLOYMENT_VAULT] = SetupDeployment{.bip = 000, .bip_version = 0, .never = true};
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // FIXME BIP number
        consensus.vDeployments[Consensus::DEPLOYMENT_VAULT] = SetupDeployment{.bip = 000, .bip_version = 0, .always = true};
