...
{
    return IsIPv4() && HasPrefix(m_addr, std::array{169_u8, 254_u8});
}
...
{
    return IsIPv4() && (HasPrefix(m_addr, std::array{192_u8, 0_u8, 2_u8}) ||
                        HasPrefix(m_addr, std::array{198_u8, 51_u8, 100_u8}) ||
                        HasPrefix(m_addr, std::array{203_u8, 0_u8, 113_u8}));
}

bool CNetAddr::IsRFC3849() const
{
    return IsIPv6() && HasPrefix(m_addr, std::array{0x20_u8, 0x01_u8, 0x0D_u8, 0xB8_u8});
}

bool CNetAddr::IsRFC3964() const
{
    return IsIPv6() && HasPrefix(m_addr, std::array{0x20_u8, 0x02_u8});
}

bool CNetAddr::IsRFC6052() const
{
    return IsIPv6() &&
           HasPrefix(m_addr, std::array{0x00_u8, 0x64_u8, 0xFF_u8, 0x9B_u8, 0x00_u8, 0x00_u8,
                                        0x00_u8, 0x00_u8, 0x00_u8, 0x00_u8, 0x00_u8, 0x00_u8});
}

bool CNetAddr::IsRFC4380() const
{
    return IsIPv6() && HasPrefix(m_addr, std::array{0x20_u8, 0x01_u8, 0x00_u8, 0x00_u8});
}

bool CNetAddr::IsRFC4862() const
{
    return IsIPv6() && HasPrefix(m_addr, std::array{0xFE_u8, 0x80_u8, 0x00_u8, 0x00_u8,
...
{
    return IsIPv6() &&
           HasPrefix(m_addr, std::array{0x00_u8, 0x00_u8, 0x00_u8, 0x00_u8, 0x00_u8, 0x00_u8,
                                        0x00_u8, 0x00_u8, 0xFF_u8, 0xFF_u8, 0x00_u8, 0x00_u8});
}

bool CNetAddr::IsRFC4843() const
{
    return IsIPv6() && HasPrefix(m_addr, std::array{0x20_u8, 0x01_u8, 0x00_u8}) &&
           (m_addr[3] & 0xF0) == 0x10;
}
...
{
    return IsIPv6() && HasPrefix(m_addr, std::array{0x20_u8, 0x01_u8, 0x04_u8, 0x70_u8});
}
